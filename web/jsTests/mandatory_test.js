...
describe("JWK and JWE", function () {
        ...
        it("generateKey(AES)/importKey(AES)/encrypt/wrapKey/unwrapKey/decrypt", function () {
            var error,

                encryptionKeyData = new Uint8Array([0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F]),
                encryptionKeyData2= new Uint8Array([0x0F, 0x0E, 0x0D, 0x0C, 0x0B, 0x0A, 0x09, 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01, 0x00]),
                encryptionKey,
                kwKey,
                wrappedKeyData,// = "",
            ...
            // import an AES wrapping key
            runs(function () {
                error = undefined;
                var op = cryptoSubtle.importKey("raw", encryptionKeyData2, { name: "AES-KW" }, false, ["wrap", "unwrap"]);
                op.onerror = function (e) {
                    error = "ERROR";
                };
                op.oncomplete = function (e) {
                    kwKey = e.target.result;
                };
            });
            waitsFor(function () {
                return kwKey || error;
            ...
            runs(function () {
                error = undefined;
                var op = cryptoSubtle.wrapKey(encryptionKey, kwKey, { name: "AES-KW" });
                op.onerror = function (e) {
                    error = "ERROR";
                };
                op.oncomplete = function (e) {
            ...
            runs(function () {
                error = undefined;
                var unwrapOp = cryptoSubtle.unwrapKey(wrappedKeyData, null, kwKey, true);
